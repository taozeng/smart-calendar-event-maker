...
var venueKeyword =["apartment","avenue","block","canteen","flat","house","floor","level","storey","room","rm","street","state","road","province","resort","town","tower","village","district","region","city","estate","bank","bakery","barbershop","salon","store","shop","plaza","mall","market","supermarket","hotel","motel","cafe","bar", "pub","bistro", "restaurant","atrium","corridor","barn","hall","building","lecture theater","lt","office","school","university","airport","tunnel","station","platform","exit","bus stop","pier","pool","hospital","library","park","castle","church","museum","stadium","court","beach","coast","forest","hill","bay","center","centre","lake","waterfall","mountain","shan","river","sea","valley"];
var historyArr;
var historyScoreArr;
var venueArr;
var savedVenue;
